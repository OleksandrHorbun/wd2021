...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\pictures\\background.jpg":[["background.9a3b8a0e.jpg","pictures/background.jpg"],"pictures/background.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/cart.js":[function(require,module,exports) {
"use strict";
...
var ul1 = document.getElementById("cart-list");
...
function showCart() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var id = item.id;
      s += "<li> ".concat(getTitleById(id), " img + ").concat(item.quantity, " - x</li>");
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function getTitleById(id) {
  var _iterator3 = _createForOfIteratorHelper(goods),
      _step3;

  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var good = _step3.value;
...
function getImgById(id) {
  var _iterator4 = _createForOfIteratorHelper(goods),
      _step4;
